...
%
% Additional fixes applied in v5 (BIORXIV AFFILIATION UPDATE):
%  21. Affiliation changed from "Independent Researcher, Tunisia" to
%      "GenoFlow Agency, Tunis, 2036 Tunisia" for bioRxiv submission
%      requirements (organizational affiliation mandatory).
% ============================================================
...
\affiliation{GenoFlow Agency, Tunis, 2036 Tunisia}
...
Approximations) gradient-free method~\cite{powell1994} with all 50~QPU
samples and 200~maximum evaluations.
...
The objective minimised was the mean squared error~(MSE) over all
50~samples on the classical proxy:
\begin{equation}
  \mathcal{L}(\theta) = \frac{1}{50}\sum_{j=1}^{50}
...
\begin{itemize}
  ...
  \item \cobyla{} was limited to 200~evaluations on the classical proxy;
